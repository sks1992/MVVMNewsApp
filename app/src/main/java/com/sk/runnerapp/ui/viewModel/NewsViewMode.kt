...
import com.sk.runnerapp.util.Resource
import kotlinx.coroutines.launch
import retrofit2.Response

class NewsViewMode(app: Application, val newsRepository: NewsRepository) : AndroidViewModel(app) {
    ...
    private fun handleHeadlinesResponse(response: Response<NewsResponse>):
